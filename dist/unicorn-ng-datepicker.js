...
angular.module('unicornNgDate', ['componentsTemplates']);;
'use strict';
...
angular.module('unicornNgDate').directive('dateFormat', ["moment", function (moment) {
  return {
    restrict: 'E',
...
angular.module('unicornNgDate').directive('dateFrom', ["moment", function (moment) {
  return {
    restrict: 'E',
...
angular.module('unicornNgDate').directive('dateInputFormat', ["moment", function (moment) {
  ...
  return {
    ...
    link: function link(scope, element, attrs, ngModelCtrl) {
      var formatter = formatDate(attrs.dateInputFormat);
